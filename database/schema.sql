...
INSERT INTO partidos (fecha, equipo_local, equipo_visitante, goles_local, goles_visitante, ganador, observaciones, created_by) VALUES
('2026-04-30', 'Dictadores', 'Tramposos', 3, 2, 'Dictadores', 'Partido intenso con definición sobre el final', NULL),
('2026-05-07', 'Tramposos', 'Dictadores', 1, 1, 'Empate', 'Encuentro parejo y muy físico', NULL),
('2026-05-14', 'Dictadores', 'Tramposos', 2, 4, 'Tramposos', 'Remontada histórica', NULL),
('2026-05-21', 'Tramposos', 'Dictadores', 0, 2, 'Dictadores', 'Defensa sólida y presión alta', NULL);
